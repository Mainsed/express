...
//axios.put('http://localhost:3000/posts', {text:'name',creator: 'jakepaul@gmail.com'}).catch((e) => {}).then((res)=>{console.log(res.data)})
...
//axios.put('http://localhost:3000/follow', {id:'1hr1r16oko4ts5cf',targetId: '1hr1r16oko1ts5cf'}).catch((e) => {}).then((res)=>{console.log(res.data)})
//axios.delete('http://localhost:3000/follow/1hr1r16oko5ts5cf/1hr1r16oko2ts5cf');
//axios.patch('http://localhost:3000/follow', {status:'Confirmed', id:'1hr1r16oko5ts5cf', targetId:'1hr1r16oko2ts5cf'})//.then((res)=>console.log(res.data))
